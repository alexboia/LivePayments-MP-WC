...
namespace LvdWcMc {
    class Uploader {
        ...
        private $_failIfNoTypeSniffed = true;
        ...
        public function __construct($key, $destinationPath, array $config = array()) {
            ...
            if (isset($config['failIfNoTypeSniffed'])) {
                $this->_failIfNoTypeSniffed = $config['failIfNoTypeSniffed'];
            }
        }
        ...
        public function setFailIfNoTypeSniffed($failIfNoTypeSniffed) {
            $this->_failIfNoTypeSniffed = $failIfNoTypeSniffed;
            return $this;
        }
        ...
        private function _isTypeValid() {
            ...
            if (empty($detectedType)) {
                return !$this->_failIfNoTypeSniffed;
            } else {
                return in_array($detectedType, $this->_allowedFileTypes);
            }
        }
