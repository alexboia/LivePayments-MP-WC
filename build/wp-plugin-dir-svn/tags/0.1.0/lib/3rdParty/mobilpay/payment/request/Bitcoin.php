 ...
 * mobilPay
 *
 * @package   Mobilpay_Payment_Request_Transfer
 ...
 */
class Mobilpay_Payment_Request_Bitcoin extends Mobilpay_Payment_Request_Abstract
{
	/**
	 *
	 ...
	 * @param DOMNode $elem
	 * @return Mobilpay_Payment_Reuquest_Transfer
	...
	/**
	 * (non-PHPdoc)
	 * @see Mobilpay_Payment_Request_Abstract::_prepare()
	 */
