...
/**
 * Class Mobilpay_Payment_Request_Transfer
 ...
 *
 */
class Mobilpay_Payment_Request_Transfer extends Mobilpay_Payment_Request_Abstract
{
    ...
    protected function _loadFromXml (DOMElement $elem)
    {
        ...
        if ($elems->length != 1)
        {
            throw new Exception('Mobilpay_Payment_Request_Transfer::loadFromXml failed; invoice element is missing', self::ERROR_LOAD_FROM_XML_ORDER_INVOICE_ELEM_MISSING);
        }
